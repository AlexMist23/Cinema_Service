...
urlpatterns = [
    ...
    path('genre/add/', GenreAddView.as_view(), name='genre_add'),
    ...
    path('repertuar/', LandingPageView.as_view(), name='cinema_select'),
    path('repertuar/<str:cinema_name>/', RepertuarView.as_view(), name='repertuar_cinema'),
